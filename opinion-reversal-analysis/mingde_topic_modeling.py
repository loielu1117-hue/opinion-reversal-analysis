...
# 读取数据
df = pd.read_csv('zhihu_limingde_cleaned.csv')
...
# 按反转日划分
reversal = pd.Timestamp('2025-02-13')
...
# 对反转前文本建模
lda_on_texts(before, n_topics=5, name='李明德_反转前')

# 对反转后文本建模
lda_on_texts(after, n_topics=5, name='李明德_反转后')